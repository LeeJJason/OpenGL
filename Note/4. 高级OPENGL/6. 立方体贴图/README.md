...
同样，我们有一个观察向量 **I**，一个法向量 **N** ，而这次是折射向量 **R** 。可以看到，观察向量的方向轻微弯曲了。弯折后的向量 **R** 将会用来从立方体贴图中采样。
...
我们使用这些折射率来计算光传播的两种材质间的比值。在我们的例子中，光线/视线从**空气**进入**玻璃**（如果我们假设箱子是玻璃制的），所以比值为  **1.00/1.52=0.658**。
